#!/usr/bin/env python3
"""
Simple editor for testing - stripped down version of Spark
"""

import sys
from PyQt6.QtWidgets import (
    QApplication, QMainWindow, QPlainTextEdit, QVBoxLayout, QWidget,
    QFileDialog, QMenuBar, QMenu, QStatusBar, QToolBar
)
from PyQt6.QtGui import QIcon, QFont, QTextCharFormat, QColor, QAction
