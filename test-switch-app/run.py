#!/usr/bin/env python3
"""
Run Test Switch App - Simple script to run the Test Switch application
"""
...
def main():
    """Run the Test Switch application."""
    # Get the file to run
    file_path = "main.mono"
...
with socketserver.TCPServer(("", PORT), SwitchHandler) as httpd:
    ...
    try:
        import webbrowser
        webbrowser.open(f"http://localhost:9090")
    except:
        print("Please open your browser and navigate to http://localhost:9090")
